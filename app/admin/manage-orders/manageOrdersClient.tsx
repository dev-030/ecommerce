...
export default function ManageOrdersClient({orders}:{orders:ExtendedOrder[]}){
    ...
    const handleDispatch = useCallback((id:StringConstructor)=>{
            axios.put('/api/order',{
                id,
    ...
    const columns:GridColDef[] = [
        ...
        {field:'paymentStatus', headerName:'Payment Status',width:130, renderCell:(params)=>{return(<div>{
        ...
        {field:'deliveryStatus', headerName:'Delivery Status',width:130,renderCell:(params)=>{return(<div>{
