...
export default function AddProductForm(){
    ...
    return(
        <>
            ...
            <Input id="price" lable="Price" disabled={isLoading} register={register} type="number" errors={errors} required/>
            <Input id="brand" lable="Brand" disabled={isLoading} register={register} errors={errors} required/>
            <TextArea id="description" lable="Description" disabled={isLoading} register={register} errors={errors} required/>
